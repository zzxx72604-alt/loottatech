...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lootta.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lootta.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("RefundDecidedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("lootta.Models.PaymentMethodSetting", b =>
                {
            ...
            modelBuilder.Entity("lootta.Models.QuickTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lootta.Models.Report", b =>
                {
                    ...
                    b.HasIndex("ReporterId", "Target", "TargetId")
                        .IsUnique();
            ...
            modelBuilder.Entity("lootta.Models.SiteText", b =>
                {
                    b.Property<string>("Key")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("lootta.Models.Report", b =>
                {
                    b.HasOne("lootta.Models.User", "Reporter")
                        .WithMany()
